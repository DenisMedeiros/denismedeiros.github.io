...
int main(int argc, char** argv)
{
	...
	if (argc != 6) 
	{
		cout << "The argument list must be: ./regions <image> <point1 x> <point1 y> <point2 x> <point2 y>" << endl;
		return -1;
	}
	...
	// Check if the points are valid (if they are placed inside the image).
